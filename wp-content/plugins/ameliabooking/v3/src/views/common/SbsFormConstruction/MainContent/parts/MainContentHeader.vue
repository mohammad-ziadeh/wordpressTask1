<template>
  <div class="am-fs__main-heading" :class="{'am-fs__main-heading-mobile': mobile}" :style="cssVars">
    <span v-if="stepIndex in sidebarSteps && 'label' in sidebarSteps[stepIndex] && ready" class="am-fs__main-heading-inner">
      <AmButton
        v-if="stepIndex > 0"
